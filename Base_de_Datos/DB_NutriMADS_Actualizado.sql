...
CREATE TABLE `consumo` (
  ...
  `Tipo` enum('Consumo realizado','Consumo Sugerido') NOT NULL,
  `Estatus` bit(1) NOT NULL DEFAULT b'1',
  `Fecha_Registro` date NOT NULL,
  `Fecha_Actualización` date DEFAULT NULL,
...
CREATE TABLE `criterio` (
  ...
  `Valor_Máximo` float NOT NULL,
  `Valr_Mínimo` float NOT NULL,
  `Estatus` enum('Saludable','No saludable') NOT NULL DEFAULT 'Saludable',
  `Fecha_Registro` date NOT NULL,
  `Fecha_Actualización` date DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `usuario` (
  ...
  `Género` enum('Femenino','Masculino') NOT NULL,
  `Peso` float NOT NULL,
...
--
-- Dumping events for database 'bd_nutrimads'
--

--
-- Dumping routines for database 'bd_nutrimads'
--
...
-- Dump completed on 2023-07-09 18:25:20
